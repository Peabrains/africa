...
-- ── D0 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d0,1,'transit','KUL → Doha (Qatar Airways)',
...
-- ── D1 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d1,1,'transit','Doha → Kilimanjaro (Qatar Airways)',
...
(v_trip_id,v_d1,2,'tanzania','Kilimanjaro → Manyara (light aircraft)',
...
(v_trip_id,v_d1,3,'tanzania','Maasai Village cultural visit',
...
(v_trip_id,v_d1,4,'tanzania','Arrive Asilia The Highlands',
...
-- ── D2 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d2,1,'tanzania','Descent into Ngorongoro Crater',
...
(v_trip_id,v_d2,2,'tanzania','Full day Ngorongoro game drive',
...
(v_trip_id,v_d2,3,'tanzania','Return to The Highlands',
...
-- ── D3 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d3,1,'tanzania','The Highlands → Manyara airstrip',
...
(v_trip_id,v_d3,2,'tanzania','Manyara → Central Serengeti (light aircraft)',
...
(v_trip_id,v_d3,3,'tanzania','Arrive Asilia Dunia Camp — lunch & afternoon game drive',
...
-- ── D4 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category) values
(v_trip_id,v_d4,1,'tanzania','Morning game drive — Central Serengeti',
...
(v_trip_id,v_d4,2,'tanzania','Afternoon game drive — Moru Kopjes region',
...
-- ── D5 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d5,1,'tanzania','Central Serengeti → Northern Serengeti (light aircraft)',
...
(v_trip_id,v_d5,2,'tanzania','Game drive en route to Asilia Olakira Camp',
...
(v_trip_id,v_d5,3,'tanzania','Afternoon game drive — Mara River vicinity',
...
-- ── D6 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category) values
(v_trip_id,v_d6,1,'tanzania','Hot Air Balloon Safari — Serengeti',
...
(v_trip_id,v_d6,2,'tanzania','Mara River game drive — Great Migration crossings',
...
-- ── D7 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category) values
(v_trip_id,v_d7,1,'tanzania','Morning game drive — Mara River crossings',
...
(v_trip_id,v_d7,2,'tanzania','Afternoon game drive — Northern Serengeti',
...
-- ── D8 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category) values
(v_trip_id,v_d8,1,'tanzania','Full day Mara River — crossing watch',
...
(v_trip_id,v_d8,2,'tanzania','Evening game drive — final Serengeti sunset',
...
-- ── D9 ───────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d9,1,'tanzania','Olakira Camp → Kilimanjaro (light aircraft)',
...
(v_trip_id,v_d9,2,'kenya','Kilimanjaro → Nairobi (Kenya Airways)',
...
(v_trip_id,v_d9,3,'kenya','Arrive Radisson Blu Nairobi Arboretum',
...
-- ── D10 ──────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d10,1,'kenya','Nairobi → Amboseli (light aircraft)',
...
(v_trip_id,v_d10,2,'kenya','Arrive Tortilis Camp — afternoon game drive',
...
-- ── D11 ──────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category) values
(v_trip_id,v_d11,1,'kenya','Morning game drive — Amboseli elephant herds',
...
(v_trip_id,v_d11,2,'kenya','Afternoon game drive — swamp & Kilimanjaro views',
...
-- ── D12 ──────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category) values
(v_trip_id,v_d12,1,'kenya','Maasai cultural walk — Amboseli',
...
(v_trip_id,v_d12,2,'kenya','Morning game drive — big cats & Kilimanjaro',
...
(v_trip_id,v_d12,3,'kenya','Afternoon at leisure — Tortilis Camp',
...
-- ── D13 ──────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d13,1,'kenya','Amboseli → Nairobi (light aircraft)',
...
(v_trip_id,v_d13,2,'kenya','Nairobi → Entebbe (Kenya Airways)',
...
(v_trip_id,v_d13,3,'uganda','Arrive No.5 Boutique Hotel — Entebbe',
...
-- ── D14 ──────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d14,1,'uganda','Entebbe → Bwindi (charter flight)',
...
(v_trip_id,v_d14,2,'uganda','Road transfer → Nkuringo Gorilla Lodge',
...
(v_trip_id,v_d14,3,'uganda','Briefing & rest at Nkuringo Gorilla Lodge',
...
-- ── D15 ──────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category) values
(v_trip_id,v_d15,1,'uganda','Mountain Gorilla Habituation Experience — Bwindi',
...
(v_trip_id,v_d15,2,'uganda','Return to Nkuringo — celebratory dinner',
...
-- ── D16 ──────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d16,1,'uganda','Nkuringo → Entebbe (charter flight)',
...
(v_trip_id,v_d16,2,'transit','Entebbe → Doha (Qatar Airways — overnight)',
...
-- ── D17 ──────────────────────────────────────────────────────
insert into public.stops (trip_id,day_id,sort_order,segment,name,activity,transport,transport_type,time,timezone,lat,lng,is_booked,needs_booking,category,flight_detail) values
(v_trip_id,v_d17,1,'transit','Doha → Kuala Lumpur (Qatar Airways)',
