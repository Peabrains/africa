...
const SEED_STOPS = [
  ...
  {id:'s02',dayId:'d0',order:1,segment:'kumano',name:'KIX → Kii-Tanabe',activity:'Collect JR Pass · head south by limited express',transport:'Haruka (KIX → Shin-Osaka) then Kuroshio Ltd Express to Kii-Tanabe',transportType:'train',time:'09:30',timeZone:'JST',notes:'Total ~2.5 hrs',lat:33.7330,lng:135.3841,hasStamp:false,isSanzan:false,trainDetail:{service:'Kuroshio Ltd Express',jrPass:true,platform:'Check board at Shin-Osaka',seatReservation:true,origin:'Shin-Osaka / Tennoji',destination:'Kii-Tanabe',arriveTime:'TBD',trainNumber:'TBD',duration:'~2 hrs'},needsBooking:true,category:'transport',booking:{status:'open',ref:'',cost:null,deadline:null}},
